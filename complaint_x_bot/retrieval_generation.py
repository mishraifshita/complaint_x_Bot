...
def generation(vstore):
    ...
    Your an expert insurance assistant designed to provide clear, accurate, and detailed answers to all insurance-related queries.
    It analyzes query and answer to provide accurate and helpful responses.
...
if __name__ == "__main__":
   ...
   answer= conversational_rag_chain.invoke(
    {"input": "can you tell me about professional liability insurance??"},
    config={
        "configurable": {"session_id": "ifshita"}
